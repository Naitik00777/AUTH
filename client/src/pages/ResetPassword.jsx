...
const ResetPassword = () => {
  ...
  return (
    <div className='flex items-center justify-center min-h-screen  bg-gradient-to-br from-blue-200 to-purple-400'>
      ...
      {!isEmailSent &&
        <form onSubmit={onSubmitEmail} className='bg-slate-900 rounded-lg p-8 shadow-lg w-96 text-sm'>
      ...
      {isOtpSubmitted && isEmailSent &&
        <form onSubmit={onSubmitNewPassword} className='bg-slate-900 rounded-lg p-8 shadow-lg w-96 text-sm'>
